...
\author*[1]{\fnm{Seyam} \sur{Alam}}\email{REPLACE-WITH-EMAIL}
\author[1]{\fnm{REPLACE} \sur{Coauthor}}\email{REPLACE-WITH-EMAIL}

\affil*[1]{\orgdiv{REPLACE Department or Laboratory}, \orgname{REPLACE Institution}, \orgaddress{\city{REPLACE City}, \country{REPLACE Country}}}
...
S.A. designed the study, implemented the pipeline, ran experiments, analyzed results, and drafted the manuscript. Additional author contributions should be added before submission.
